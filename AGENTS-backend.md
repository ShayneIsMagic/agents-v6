...
> **Stack:** Python · Flask · Postgres · SQLAlchemy · Marshmallow · Pipenv

Guidelines for the Flask backend of a full-stack application. The frontend is a **separate repo** — integration happens only through a documented HTTP API.
